...
def get_fake_wind_speed(last_wind_speed=None):
...
def get_fake_wind_direction(last_wind_direction=None):
...
def get_fake_visibility(last_visibility=None):
...
WEATHER = {  # example call: POSITION["lat_long"](last_wind_direction=75)
    "wind_speed": get_fake_wind_speed,
    "wind_direction": get_fake_wind_direction,
    "visibility": get_fake_visibility
}
