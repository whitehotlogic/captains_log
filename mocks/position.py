...
class FakePosition:
    ...
    def speed(self, last_speed=None):
    ...
    def direction(self, last_direction=None):
    ...
    def position(
        ...
        if speed is None:
            if last_latitude is None and last_longitude is None:
                new_speed = self.speed(last_speed=random.randint(3, 8))
            else:
        ...
        if last_direction is None:
            ...
            new_direction = self.direction(last_direction=last_direction)
